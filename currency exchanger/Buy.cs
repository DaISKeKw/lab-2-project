...
namespace currency_exchanger
{
    public partial class Buy : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox1.Text = (rates[selectedIndex].Sale * result).ToString() + "UAH";
                Logger logger = new Logger();
                logger.WriteLog(true, date, rates[selectedIndex].Sale, rates[selectedIndex].Sale * result, result, firstThreeCharacters);
            }
            else
            {
